...
- 落地需求：`总领文档/医院智能体与医生工作台/医院演示客户端落地需求.md`。
- 医生简介与首条系统卡：`总领文档/医院智能体与医生工作台/医生简介与智能体首条系统卡需求.md`。
...
- 目标：新增独立医院 RootTab、新医院首页和院内对话列表；增加挂号能力声明、科室与医生智能体目录，并在现有对话中明确区分患者、AI 助手和真人医生。
