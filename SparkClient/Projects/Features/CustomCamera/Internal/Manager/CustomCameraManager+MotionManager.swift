//
//  CustomCameraManager+MotionManager.swift of MijickCamera
//
...
@MainActor class CustomCameraManagerMotionManager {
    private(set) var parent: CustomCameraManager!
    private(set) var manager: CMMotionManager = .init()
}

// MARK: Setup
extension CustomCameraManagerMotionManager {
...
private extension CustomCameraManagerMotionManager {
