...
/// 病例档案拍摄引导页。
struct CaseDocumentCameraGuideView: View {
        ...
        CompatibleNavigationContainer(legacyStackStyle: true) {
            ScrollView(showsIndicators: false) {
                VStack(spacing: 0) {
                    ...
                    Text(L10n.text("home.medical.case_document.camera.guide.title", fallback: "病历拍摄"))
...
private extension CaseDocumentCameraGuideView {
    ...
    var startButton: some View {
        Button(action: onDismiss) {
            Text(L10n.text("home.medical.case_document.camera.guide.start", fallback: "开始拍摄"))
