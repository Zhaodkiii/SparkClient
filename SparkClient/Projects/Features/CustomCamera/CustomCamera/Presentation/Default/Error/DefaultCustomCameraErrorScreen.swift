//
//  DefaultCustomCameraErrorScreen.swift of MijickCamera
//
...
struct DefaultCustomCameraErrorScreen: CustomCameraErrorScreen {
...
private extension DefaultCustomCameraErrorScreen {
    func createCloseButton() -> some View {
        CloseButton(action: closeCustomCameraAction)
