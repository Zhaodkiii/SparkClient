 ...
 */
public struct SecondCameraEditorWeak<T> {
...
public struct SecondCameraEditorWeakArray<Element> {
    private var array: [SecondCameraEditorWeak<Element>] = []
    ...
    public mutating func append(_ element: Element) {
        array = array.filter { $0.value != nil } + [SecondCameraEditorWeak(value: element)]
    }
...
extension SecondCameraEditorWeakArray: ExpressibleByArrayLiteral {
...
extension SecondCameraEditorWeakArray where Element: Equatable {
