...
public struct SecondCameraEditorFileHandleImageSource: SecondCameraEditorImageSource {
    ...
    public init(fileUrl: URL) throws {
        let byteLength = Int((try? SecondCameraEditorFileSystem.fileSize(of: fileUrl)) ?? 0)
    ...
    public func cgImageSource() throws -> CGImageSource? {
        ...
        guard
            ...
            throw SecondCameraEditorAssertionError("Failed to create data provider")
        }
