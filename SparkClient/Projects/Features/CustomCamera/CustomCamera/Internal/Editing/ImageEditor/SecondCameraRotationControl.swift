...
class SecondCameraRotationControl: UIControl {
    ...
    init() {
        ...
        layoutMargins = .zero
        tintColor = .secondCameraEditor_white
    ...
    override var intrinsicContentSize: CGSize {
        ...
        CGSize(width: SecondCameraRotationControl.preferredWidth, height: UIView.noIntrinsicMetric)
    }

    private lazy var hapticFeedbackGenerator = SecondCameraEditorSelectionHapticFeedback()
...
extension SecondCameraRotationControl: UIScrollViewDelegate {
    ...
    private func initializeRuler() {
        ...
        for i in 0...numberOfSteps {
            ...
            marking.backgroundColor = .secondCameraEditor_white
