...
enum SecondCameraImageEditorError: Int, Error {
    case assertionError
    case invalidInput
}

enum SecondCameraImageEditorItemType: Int {
    case test
    case stroke
    case text
    case sticker
...
// * 0.0 = top edge
// * 1.0 = bottom edge
typealias SecondCameraImageEditorSample = CGPoint

// MARK: -

// Instances of SecondCameraImageEditorItem should be treated
// as immutable, once configured.

class SecondCameraImageEditorItem: NSObject {

    let itemId: String

    let itemType: SecondCameraImageEditorItemType

    init(itemType: SecondCameraImageEditorItemType) {
    ...
    init(itemId: String, itemType: SecondCameraImageEditorItemType) {
        self.itemId = itemId
        self.itemType = itemType
