...
class SecondCameraImageEditorStrokeItem: SecondCameraImageEditorItem {
    ...
    typealias StrokeSample = SecondCameraImageEditorSample
    ...
    func strokeWidth(forDstSize dstSize: CGSize) -> CGFloat {
        SecondCameraImageEditorStrokeItem.strokeWidth(forUnitStrokeWidth: unitStrokeWidth, dstSize: dstSize)
    }
    ...
    class func strokeWidth(forUnitStrokeWidth unitStrokeWidth: CGFloat, dstSize: CGSize) -> CGFloat {
        return CGFloat.secondCameraEditor_clamp01(unitStrokeWidth) * min(dstSize.width, dstSize.height)
    }
}
